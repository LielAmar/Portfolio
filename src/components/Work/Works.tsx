    ...
    <section id="work" className={ styles.works }>
      <div className={ styles.worksWrapper }>
        ...
        <div className={ styles.worksContainer }>
          ...
          <Work img="images/minestore.png" alt="Minestore Plugin" imgHref="https://github.com/LielAmar/Minestore" title="Minestore" titleHref="https://bit.ly/3fhysUM" role="Developer & UI Designer">
            <p>
          ...
          <Work img="images/lielsutils.png" alt="Liel's Utils Lib" imgHref="https://github.com/LielAmar/LielsUtils" title="Liel's Utils" titleHref="https://github.com/LielAmar/LielsUtils" role="Developer">
            <p>
          ...
          <Work img="images/partygames.png" alt="Party Games Plugin" imgHref="https://github.com/LielAmar/Party-Games" title="Party Games" titleHref="https://github.com/LielAmar/Party-Games" role="Developer">
            <p>
          ...
          <Work img="images/2fa.png" alt="2FA Plugin" imgHref="https://github.com/LielAmar/2FA" title="2FA" titleHref="https://bit.ly/3wzBsBQ" role="Developer">
            <p>
          ...
          <Work img="images/armsrace.png" alt="Arms Race Plugin" imgHref="https://bit.ly/3oPl9hB" title="Arms Race" titleHref="https://bit.ly/3oPl9hB" role="Developer">
            <p>
          ...
          <Work img="images/lielscore.png" alt="Liel's Core Lib" imgHref="https://github.com/LielAmar/LielsCore" title="2FA Plugin" titleHref="https://github.com/LielAmar/LielsCore" role="Developer">
            <p>
          ...
          <Work img="images/talecraft.png" alt="Talecraft SMP" imgHref="https://talecraft.co.il/" title="Talecraft" titleHref="https://talecraft.co.il/" role="Developer & Manager">
            <p>
          ...
          <Work img="images/play-il.png" alt="Play-IL" imgHref="https://forum.play-il.co.il/member/8558-lielamar" title="Play-IL" titleHref="https://forum.play-il.co.il/" role="Management Team">
            <p>
          ...
          <Work img="images/play-il network.png" alt="Play-IL Network" imgHref="https://www.youtube.com/watch?v=upHr3M-UoPI" title="Play-IL Network" titleHref="https://www.youtube.com/watch?v=upHr3M-UoPI" role="Manager & Lead Developer">
            <p>
          ...
          <Work img="images/youtube.png" alt="Youtube Channel" imgHref="https://www.youtube.com/channel/UCK9c8Rixqzy7LqG8eBDy9Fg" title="Youtube Channel" titleHref="https://www.youtube.com/channel/UCK9c8Rixqzy7LqG8eBDy9Fg" role="Editor & Designer">
            <p>
          ...
          <Work img="images/cybernet.png" alt="Cybernet's Logo" imgHref="https://cybernet.co.il/" title="Attendance System" titleHref="https://cybernet.co.il/" role="Developer & UI Designer">
            <p>
          ...
          <Work img="images/completepermissions.png" alt="Complete Permissions Plugin" imgHref="https://github.com/LielAmar/CompletePermissions" title="CompletePermissions" titleHref="https://bit.ly/3vfng0p" role="Developer">
            <p>
          ...
          <Work img="images/mycinema.png" alt="MyCinema Android App" imgHref="https://github.com/LielAmar/MyCinema" title="MyCinema" titleHref="https://github.com/LielAmar/MyCinema" role="Developer & UI Designer">
            <p>
