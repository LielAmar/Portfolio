    ...
    <section id="work" className={ styles.works }>
      <div className={ styles.worksWrapper }>
        ...
        <div className={ styles.worksContainer }>
          <Work img="images/idf.webp" alt="Israel Defense Forces" imgHref="https://www.idf.il/en/" title="Israel Defense Forces" titleHref="https://www.idf.il/en/" role="Lead Developer">
            <p>
          ...
          <Work img="images/hypixel.webp" alt="Hypixel" imgHref="https://hypixel.net/members/lielamar.175428/" title="Hypixel Network" titleHref="https://hypixel.net/" role="Staff Member">
            <p>
          ...
          <Work img="images/minestore.webp" alt="Minestore Plugin" imgHref="https://github.com/LielAmar/Minestore" title="Minestore" titleHref="https://bit.ly/3fhysUM" role="Developer & UI Designer">
            <p>
          ...
          <Work img="images/lielsutils.webp" alt="Liel's Utils Lib" imgHref="https://github.com/LielAmar/LielsUtils" title="Liel's Utils" titleHref="https://github.com/LielAmar/LielsUtils" role="Developer">
            <p>
          ...
          <Work img="images/partygames.webp" alt="Party Games Plugin" imgHref="https://github.com/LielAmar/Party-Games" title="Party Games" titleHref="https://github.com/LielAmar/Party-Games" role="Developer">
            <p>
          ...
          <Work img="images/2fa.webp" alt="2FA Plugin" imgHref="https://github.com/LielAmar/2FA" title="2FA" titleHref="https://bit.ly/3wzBsBQ" role="Developer">
            <p>
          ...
          <Work img="images/languagefix.webp" alt="Language Fix Plugin" imgHref="https://github.com/LielAmar/LanguageFix" title="Language Fix" titleHref="https://bit.ly/3hMGZ3I" role="Developer">
            <p>
          ...
          <Work img="images/armsrace.webp" alt="Arms Race Plugin" imgHref="https://bit.ly/3oPl9hB" title="Arms Race" titleHref="https://bit.ly/3oPl9hB" role="Developer">
            <p>
          ...
          <Work img="images/lielscore.webp" alt="Liel's Core Lib" imgHref="https://github.com/LielAmar/LielsCore" title="Liel's Core" titleHref="https://github.com/LielAmar/LielsCore" role="Developer">
            <p>
          ...
          <Work img="images/talecraft.webp" alt="Talecraft SMP" imgHref="https://talecraft.co.il/" title="Talecraft" titleHref="https://talecraft.co.il/" role="Developer & Manager">
            <p>
          ...
          <Work img="images/play-il_network.webp" alt="Play-IL Network" imgHref="https://www.youtube.com/watch?v=upHr3M-UoPI" title="Play-IL Network" titleHref="https://www.youtube.com/watch?v=upHr3M-UoPI" role="Manager & Lead Developer">
            <p>
          ...
          <Work img="images/youtube.webp" alt="Youtube Channel" imgHref="https://www.youtube.com/channel/UCK9c8Rixqzy7LqG8eBDy9Fg" title="Youtube Channel" titleHref="https://www.youtube.com/channel/UCK9c8Rixqzy7LqG8eBDy9Fg" role="Editor & Designer">
            <p>
          ...
          <Work img="images/lielsbot.webp" alt="Liel's Discord Bot" imgHref="https://github.com/LielAmar/LielsBot" title="Liel's Discord Bot" titleHref="https://discord.com/invite/NzgBrqR" role="Developer">
            <p>
          ...
          <Work img="images/cybernet.webp" alt="Cybernet's Logo" imgHref="https://cybernet.co.il/" title="Attendance System" titleHref="https://cybernet.co.il/" role="Developer & UI Designer">
            <p>
          ...
          <Work img="images/completepermissions.webp" alt="Complete Permissions Plugin" imgHref="https://github.com/LielAmar/CompletePermissions" title="CompletePermissions" titleHref="https://bit.ly/3vfng0p" role="Developer">
            <p>
          ...
          <Work img="images/mycinema.webp" alt="MyCinema Android App" imgHref="https://github.com/LielAmar/MyCinema" title="MyCinema" titleHref="https://github.com/LielAmar/MyCinema" role="Developer & UI Designer">
            <p>
