    ...
    <>
      <div className="relative space-y-4">
        ...
        <h3 className="text-secondary text-base font-normal">
          The best way to contact me is directly via email, at <u><a href="mailto: liel@lielamar.com">liel@lielamar.com</a></u>. Alternatively, send me a message on any platform I'm active on!
        </h3>
